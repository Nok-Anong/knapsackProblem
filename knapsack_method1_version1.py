...
#Start construction method 1 by sort value increasing-----------------------------
...
while(j < iteration):
      ...
      in_knapsack = df_temp.loc[df_temp['knapsack']==1] # in Knapsack
      not_knapsack= df_temp.loc[df_temp['knapsack']==0]# not in knapsack
